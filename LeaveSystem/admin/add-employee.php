<?php
    ...
    $sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Department,Status) VALUES(:empid,:fname,:lname,:email,:password,:department,:status)";
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="dashboard.php"><img src="https://afsholdings.co.ke/wp-content/uploads/2024/02/cropped-8fae47ac-3b7f-4b9b-98b1-0028412db9d6-1.jpg" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <input class="form-control" name="mobileno" type="tel"  maxlength="10" autocomplete="off">
                                        </div> -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <i<nput class="form-control" name="city" type="text"   autocomplete="off">
                                        </div> -->
