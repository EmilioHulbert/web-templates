<?php
    ...
    $sql="update tblemployees set FirstName=:fname,LastName=:lname,Department=:department where EmailId=:eid";
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="leave.php"><img src="https://afsholdings.co.ke/wp-content/uploads/2024/02/cropped-8fae47ac-3b7f-4b9b-98b1-0028412db9d6-1.jpg" alt="logo" onclick="window.open('https://afsholdings.co.ke')">Visit Our Website></a>
                </div>
            </div>
            <div class="main-menu">
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="dob" id="birthdate" value="">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Contact Number</label>
                                            <input class="form-control" name="mobileno" type="tel" value="" maxlength="10" autocomplete="off" required>
                                        </div> -->
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <input class="form-control" name="country" type="text"  value="" autocomplete="off" required id="example-text-input">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Address</label>
                                            <input class="form-control" name="address" type="text"  value="" autocomplete="off" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">City</label>
                                            <input class="form-control" name="city" type="text"  value="" autocomplete="off" required>
                                        </div> -->
...
<!-- nimetoa some code check snippets -->